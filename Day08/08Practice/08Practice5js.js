...
// let 제품명 = prompt("제품명을 입력해주세요")
// let 가격 = prompt("가격을 입력해주세요")
// let 제조사 = prompt("제조사을 입력해주세요")
...
// { id: 'user2', password: 'pass2', name: '사용자2' },
// ];
// //keys 는 객체의 개수 ex) [ '0' , '1'] 가 /  values 는 전체가 /  entries 는 keys와 values값이 나옴. 
...
// }else if(member.id == members[1].id){
//     console.log("존재하는 아이디입니다.")
// }else{
//     members.push(member)
//     console.log(members)
...
// let 수학평균 = (scores[0].math +scores[1].math +scores[2].math)/3
// console.log(수학평균)  
...
//         개발팀.push(team[i].name)
//     }else{
//         기획팀.push(team[i].name)
//     }
// } console.log(개발팀); console.log(기획팀);
